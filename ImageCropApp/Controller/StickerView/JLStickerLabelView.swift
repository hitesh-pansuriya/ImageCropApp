...
extension JLStickerLabelView: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        if textView.text != "" {
            adjustsWidthToFillItsContens(self, labelView: labelTextView)
            labelTextView.attributedText = NSAttributedString(string: labelTextView.text, attributes: labelTextView.textAttributes as? [NSAttributedString.Key : Any] ?? [:])
...
extension JLStickerLabelView {
    ...
    func setupCloseAndRotateView() {
        ...
        closeView?.image = UIImage(systemName: "multiply")
        ...
        rotateView?.image = UIImage(systemName: "goforward")
